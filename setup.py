...
plugin_identifier = "SkipTo"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_skipto"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-SkipTo"
...
# module
plugin_description = """Allows to skip printing to a specific layer or z-height - useful for restarting failed print without mucking around with gcode file"""
